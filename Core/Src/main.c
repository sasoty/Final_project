...
int main(void)
{
  /* USER CODE BEGIN 1 */
    HX711 H;
    	H.PD_SCK_PinType = GPIOB;
  	H.PD_SCK_PinNumber = GPIO_PIN_12;
  	H.DOUT_PinType = GPIOB;
  	H.DOUT_PinNumber = GPIO_PIN_11;
  	H.offset = 0;
  	H.mode = 0;
